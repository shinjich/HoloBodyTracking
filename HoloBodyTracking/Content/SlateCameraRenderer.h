...
namespace BasicHologram
{
	...
	public:
			...
			ModelRenderer(deviceResources)
		{
			...
			m_pImageTemp = new UINT16[RESOLUTION_SIZE];
			m_dwImageSum = 0;
		}
	...
	protected:
		...
		virtual bool UpdateTextureFromCameraFrame(IResearchModeSensorFrame* pSensorFrame, std::shared_ptr<Texture2D> texture2D, RBT_STRUCT* pImageRBT);
